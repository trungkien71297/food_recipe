...
part of 'food_recipe_infra.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class FoodRecipeInfraAdapter extends TypeAdapter<FoodRecipeInfra> {
  @override
  final int typeId = 1;

  @override
  FoodRecipeInfra read(BinaryReader reader) {
    ...
    return FoodRecipeInfra(
      ...
      strSource: fields[8] as String,
      recipeInMap: (fields[9] as Map)?.cast<String, String>(),
    );
  }

  @override
  void write(BinaryWriter writer, FoodRecipeInfra obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.idMeal)
  ...
  bool operator ==(Object other) =>
      ...
      other is FoodRecipeInfraAdapter &&
...
Map<String, dynamic> _$FoodRecipeInfraToJson(FoodRecipeInfra instance) =>
    <String, dynamic>{
