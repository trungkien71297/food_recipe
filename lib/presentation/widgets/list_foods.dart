...
import 'package:jokes/presentation/widgets/food_item.dart';
...
class ListFoods extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate:
          SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 2/2.5, crossAxisSpacing: 5, mainAxisSpacing: 5),
